...
class VCLLoggingTableVC: UITableViewController {
    ...
    private func logVCL(_ msg: String) {
        if instanceCount == nil {
            instanceCount =  VCLLoggingTableVC.bumpInstanceCount(for: vclLoggingName)
        }
        print("\(VCLLoggingTableVC.logPrefix(for: vclLoggingName))(\(instanceCount!)) \(msg)")
    }
